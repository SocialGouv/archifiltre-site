...
<Grid container spacing={3} justify="center">
    <Grid item md={3}>
        ...
        <Button
            target="_blank"
            href="https://github.com/SocialGouv/archifiltre-docs/projects/1"
            color="primary"
            size="small"
            endIcon={<MapIcon />}
        >
...
## v3.2.2 Romantic Raccoon - 22/09/2021 {#322}

Cette version est un patch qui corrige un bug empêchant le calcul et le chargement d'empreinte d'archives importantes sur la version 3.2.1
...
- La **sécurité** a été renforcée : Archifiltre est désormais **signé** sur **Windows** et **Mac** : c'est donc une application reconnue par Microsoft et Apple. De plus, un **hash de version** est généré pour garantir que le binaire téléchargé n'a pas été corrompu.
- Il est désormais possible de **zoomer sur les stalactites** avec la molette de la souris ou un bouton de la barre de navigation
- La **gestion des erreurs** a été améliorée pour éviter les erreurs silencieuses
- De nombreux **bugs** ont été **corrigés**, notamment sur les imports et les exports
- Il est maintenant possible de **changer la date de dernière modification d'un fichier** dans l'onglet "Général"
- La **confidentialité** a été améliorée pour mieux respecter le RGPD. Les données remontées sont désormais anonymisées. Elles sont consultables dans la [FAQ](https://archifiltre.fabrique.social.gouv.fr/faq).
- La fenêtre d'exports a évolué pour vous permettre des **exports multiples**, et ajoute un nouvel élément : un **script de suppression**
- Enfin, un **bouton d'aide** a été ajouté en bas à droite de l'interface pour vous rediriger les liens utiles

## v3.1.1 Queer Quetzal - 05/11/2020 {#311}
...
- Enfin, nous vous invitons toujours à remplir notre [questionnaire pour nous donner vos retours](https://archifiltre.fabrique.social.gouv.fr/questionnaire/)

## v3.1.0 Queer Quetzal - 26/10/2020 {#310}

Cette version est une évolution de la version 3 sortie cet été. En voici les principales nouveautés :
...
- Enfin, nous mettons à votre disposition un [questionnaire pour nous donner vos retours](https://archifiltre.fabrique.social.gouv.fr/questionnaire/)
...
Enfin, les astuces ont été déplacées de l‘écran de chargement vers ce [wiki](https://github.com/SocialGouv/archifiltre-docs/wiki/Astuces).
